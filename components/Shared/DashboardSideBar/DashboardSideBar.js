          ...
          <ul className="pt-2 pb-4 space-y-1 text-lg flex flex-col gap-4">
            <li className="dark:bg-gray-800 dark:text-gray-50">
              ...
              <Link href={`/dashboard/addnews`}>
                <span className={hide ? "hidden" : "inline"}> AddNews</span>
              </Link>
            </li>
            <li className="dark:bg-gray-800 dark:text-gray-50">
              <CgAddR className="inline-block ml-4 mr-6 h-7 text-white"></CgAddR>
              <Link href={`/dashboard/e-paper-edition`}>
                <span className={hide ? "hidden" : "inline text-sm"}>
                  {" "}
                  E-Paper Edition
                </span>
              </Link>
