...
const Categories = () => {
    ...
    return (
        <div className='max-w-[1440px] w-[95%] mx-auto'>
            ...
            <h2 className='title uppercase p-10 text-center mt-24 mb-10 bg-purple-300 text-black text-2xl font-semibold'>Add News Category </h2>
            ...
            <div className="flex flex-wrap justify-center items-center mx-auto  gap-2">
                ...
                <TextInput
                    id="base"
                    type="text"
                    className='text-gray-600 w-[270px] font-semibold'
                    placeholder='input news category name'
                    sizing="lg"
                />

                <Button gradientMonochrome="info" className='w-[150px] h-[60px] text-xl font-bold' >
                    Add Category
                </Button>
