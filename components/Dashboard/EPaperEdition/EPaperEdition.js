...
const EPaperEdition = () => {
  ...
  const handleAdd = (e) => {
    e.preventDefault();
    const name = e.target.editionName.value;
    const data = { name };
    fetch("http://localhost:5000/addalias", {
      method: "POST",
      headers: {
        "content-type": "application/json",
      },
      ...
      <div className="flex-grow">
        ...
        <Table striped={true}>
          <Table.Head>
            ...
            <Table.HeadCell>Edition Name</Table.HeadCell>
